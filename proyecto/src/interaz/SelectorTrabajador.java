...
public class SelectorTrabajador extends javax.swing.JDialog {
    ...
    public SelectorTrabajador(java.awt.Frame parent, boolean modal) {
        ...
        try {
            tabla_Trabajador.setModel(Conexion_db.obtenerTrabajadores());
    ...
    private void initComponents() {
        ...
        tabla_Trabajador = new javax.swing.JTable();
        ...
        tabla_Trabajador.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tabla_TrabajadorKeyPressed(evt);
            }
        });
    ...
    private void tabla_TrabajadorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_TrabajadorMousePressed
        if (tabla_Trabajador.getSelectedRow() != -1) {
            btn_Aceptar.setEnabled(true);
        }
    }//GEN-LAST:event_tabla_TrabajadorMousePressed

    private void tabla_TrabajadorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_TrabajadorKeyPressed
        //filaSeleccionada();
    }//GEN-LAST:event_tabla_TrabajadorKeyPressed
    private String [] trab; private boolean Seleccionada = false;
    private void btn_AceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_AceptarMouseClicked
        int Seleccion = tabla_Trabajador.getSelectedRow();
        if (Seleccion != -1) {
            trab = new String[]{tabla_Trabajador.getValueAt(Seleccion, 0).toString(), tabla_Trabajador.getValueAt(Seleccion, 1).toString()};
            Seleccionada = true;
            this.setVisible(false);
        }
    ...
    private javax.swing.JTable tabla_Trabajador;
