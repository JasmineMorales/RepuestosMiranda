...
//        }
    ...
    private void initComponents() {
        ...
        btn_Activos = new javax.swing.JLabel();
        ...
        btn_Activos.setBackground(new java.awt.Color(0, 0, 0));
        btn_Activos.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        btn_Activos.setForeground(new java.awt.Color(255, 255, 255));
        btn_Activos.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btn_Activos.setText("ACTIVOS");
        btn_Activos.setName(""); // NOI18N
        btn_Activos.setOpaque(true);
        btn_Activos.setPreferredSize(new java.awt.Dimension(93, 40));
        btn_Activos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_ActivosMouseClicked(evt);
            }
        });
        pn_herramientas.add(btn_Activos, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 138, -1));
...
//        }
    ...
    private void btn_verMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_verMouseClicked
        if(btn_ver.isEnabled()){
            ...
            btn_Activos.setBackground(Color.black);
            modificar=false;
            nuevo=false;
            cargarProductoActual();
            cambiarModo();
...
//                 }
    ...
    private void btn_ActivosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_ActivosMouseClicked
        if(btn_Activos.isEnabled()){
            btn_modificar.setBackground(Color.BLACK);
            btn_nuevo.setBackground(Color.BLACK);
            btn_ver.setBackground(Color.BLACK);
            btn_Activos.setBackground(Color.RED);
            pnContenido1.setVisible(true);
            pnContenido.setVisible(false);
//            JPanel j = new Activos(conexion);
//            j.setLocation(0, 0);
//            j.setSize(pnContenido1.getSize());
//            pnContenido1.removeAll();
//            pnContenido1.add(j, BorderLayout.CENTER);
//            pnContenido1.revalidate();
//            pnContenido1.repaint();
//            pnContenido1.repaint();
        }
    }//GEN-LAST:event_btn_ActivosMouseClicked
    
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel Salir1;
    private javax.swing.JLabel btn_Activos;
